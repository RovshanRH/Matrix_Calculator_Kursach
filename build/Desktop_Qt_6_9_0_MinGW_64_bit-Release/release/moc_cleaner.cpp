...
namespace {
struct qt_meta_tag_ZN7CleanerE_t {};
} // unnamed namespace

template <> constexpr inline auto Cleaner::qt_create_metaobjectdata<qt_meta_tag_ZN7CleanerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Cleaner, qt_meta_tag_ZN7CleanerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Cleaner::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7CleanerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7CleanerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7CleanerE_t>.metaTypes,
    nullptr
} };
...
void *Cleaner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7CleanerE_t>.strings))
